  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (res.token) {
        ...
        router.push("/user"); // Redirige a la página de validación
      } else {
    ...
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 w-full">
        <div className="p-4">
          ...
          <div className="relative mt-8 border p-10">
            <div className="text-2xl p-4 w-1/4 m-auto">
            ...
            <div className="container p-3">
              <div className="flex gap-12 justify-center">
                ...
                <div className="relative text-xl">
                  ...
                  <input
                    className="peer block w-28 rounded-md border border-gray-200 p-3 text-xl outline-2 text-scale-600"
                    id="address.number"
                    type="text"
                ...
                <div className="relative text-xl">
                  ...
                  <input
                    className="peer block w-44 rounded-md border border-gray-200 p-3 text-xl outline-2 text-scale-600"
                    id="address.postal"
                    type="text"
                  ...
                  {errors.address?.postal && (
                    <p>{errors.address.postal.message}</p>
                  )}
                </div>
              </div>

  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
      <div className="flex-1 rounded-lg bg-orange-400 bg-opacity-75 px-6 pb-8 pt-4">
        <h1 className="mb-5  text-4xl text-shadow-lg text-blue-900 font-bold">
          Crea tu cuenta
        </h1>
      ...
      <div className="mt-6 text-2xl w-auto text-shadow-xl text-orange-700 text-center font-bold">
        ¿Ya tienes cuenta?
        <Link href="/login">
          <span className=" ml-3 text-blue-900 text-4xl text-shadow-lg font-bold">
            Accede
          </span>
        </Link>
      </div>
